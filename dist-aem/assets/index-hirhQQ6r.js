...
`)+`
`+m);const y=x+p+o,v=x+m+a,T=Pm(i,i.VERTEX_SHADER,y),E=Pm(i,i.FRAGMENT_SHADER,v);i.attachShader(g,T),i.attachShader(g,E),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function b(L){if(r.debug.checkShaderErrors){const k=i.getProgramInfoLog(g).trim(),H=i.getShaderInfoLog(T).trim(),U=i.getShaderInfoLog(E).trim();let j=!0,$=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(j=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,g,T,E);else{const C=Dm(i,T,"vertex"),q=Dm(i,E,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
