...
// Helper function to get preloaded assets or fallback to normal loading
function getPreloadedAssetUrl(assetName, fallbackUrl) {
  ...
  if (window.PRELOADED_ASSETS && window.PRELOADED_ASSETS[assetName]) {
    // Create a blob URL from the preloaded asset data
    const asset = window.PRELOADED_ASSETS[assetName];
