...
`)+`
`+p);const y=b+m+o,v=b+p+a,E=sd(i,i.VERTEX_SHADER,y),C=sd(i,i.FRAGMENT_SHADER,v);i.attachShader(_,E),i.attachShader(_,C),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function w(P){if(r.debug.checkShaderErrors){const O=i.getProgramInfoLog(_).trim(),B=i.getShaderInfoLog(E).trim(),$=i.getShaderInfoLog(C).trim();let q=!0,V=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(q=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,E,C);else{const F=ad(i,E,"vertex"),H=ad(i,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
)`),pw=RegExp("".concat(Cf,"(?=").concat(Cf,")|").concat(dw).concat(hw),"g"),mw=[J_,mh,q_,Y_,$_],_w=RegExp("[".concat(mw.join(""),"]"));function gw(r){return r.split("")}function tg(r){return _w.test(r)}function vw(r){return r.match(pw)||[]}function xw(r){return tg(r)?vw(r):gw(r)}function yw(r){return r==null?"":String(r)}function Sw(r){var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"";return r=yw(r),r&&Ra(r)&&!e&&tg(r)?xw(r):r.split(e)}function Rf(r,e){var t=document.createElement(r);return e&&Object.keys(e).forEach(function(n){var i=e[n],s=Ra(i)?i.trim():i;s===null||s===""||(n==="children"?t.append.apply(t,En(_s(s))):t.setAttribute(n,s))}),t}var _h={splitClass:"",lineClass:"line",wordClass:"word",charClass:"char",types:["lines","words","chars"],absolute:!1,tagName:"div"};function bw(r,e){e=es(_h,e);var t=ph(e.types),n=e.tagName,i=r.nodeValue,s=document.createDocumentFragment(),o=[],a=[];return/^\s/.test(i)&&s.append(" "),o=lw(i).reduce(function(l,c,u,h){var f,d;return t.chars&&(d=Sw(c).map(function(g){var _=Rf(n,{class:"".concat(e.splitClass," ").concat(e.charClass),style:"display: inline-block;",children:g});return Di(_,"isChar",!0),a=[].concat(En(a),[_]),_})),t.words||t.lines?(f=Rf(n,{class:"".concat(e.wordClass," ").concat(e.splitClass),style:"display: inline-block; ".concat(t.words&&e.absolute?"position: relative;":""),children:t.chars?d:c}),Di(f,{isWord:!0,isWordStart:!0,isWordEnd:!0}),s.appendChild(f)):d.forEach(function(g){s.appendChild(g)}),u<h.length-1&&s.append(" "),t.words?l.concat(f):l},[]),/\s$/.test(i)&&s.append(" "),r.replaceWith(s),{words:o,chars:a}}function ng(r,e){var t=r.nodeType,n={words:[],chars:[]};if(!/(1|3|11)/.test(t))return n;if(t===3&&/\S/.test(r.nodeValue))return bw(r,e);var i=_s(r.childNodes);if(i.length&&(Di(r,"isSplit",!0),!ts(r).isRoot)){r.style.display="inline-block",r.style.position="relative";var s=r.nextSibling,o=r.previousSibling,a=r.textContent||"",l=s?s.textContent:" ",c=o?o.textContent:" ";Di(r,{isWordEnd:/\s$/.test(a)||/^\s/.test(l),isWordStart:/^\s/.test(a)||/\s$/.test(c)})}return i.reduce(function(u,h){var f=ng(h,e),d=f.words,g=f.chars;return{words:[].concat(En(u.words),En(d)),chars:[].concat(En(u.chars),En(g))}},n)}function Mw(r,e,t,n){if(!t.absolute)return{top:e?r.offsetTop:null};var i=r.offsetParent,s=G_(n,2),o=s[0],a=s[1],l=0,c=0;if(i&&i!==document.body){var u=i.getBoundingClientRect();l=u.x+o,c=u.y+a}var h=r.getBoundingClientRect(),f=h.width,d=h.height,g=h.x,_=h.y,m=_+a-c,p=g+o-l;return{width:f,height:d,top:m,left:p}}function ig(r){ts(r).isWord?(X_(r),r.replaceWith.apply(r,En(r.childNodes))):_s(r.children).forEach(function(e){return ig(e)})}var Ew=function(){return document.createDocumentFragment()};function ww(r,e,t){var n=ph(e.types),i=e.tagName,s=r.getElementsByTagName("*"),o=[],a=[],l=null,c,u,h,f=[],d=r.parentElement,g=r.nextElementSibling,_=Ew(),m=window.getComputedStyle(r),p=m.textAlign,b=parseFloat(m.fontSize),y=b*.2;return e.absolute&&(h={left:r.offsetLeft,top:r.offsetTop,width:r.offsetWidth},u=r.offsetWidth,c=r.offsetHeight,Di(r,{cssWidth:r.style.width,cssHeight:r.style.height})),_s(s).forEach(function(v){var E=v.parentElement===r,C=Mw(v,E,e,t),w=C.width,R=C.height,S=C.top,x=C.left;/^br$/i.test(v.nodeName)||(n.lines&&E&&((l===null||S-l>=y)&&(l=S,o.push(a=[])),a.push(v)),e.absolute&&Di(v,{top:S,left:x,width:w,height:R}))}),d&&d.removeChild(r),n.lines&&(f=o.map(function(v){var E=Rf(i,{class:"".concat(e.splitClass," ").concat(e.lineClass),style:"display: block; text-align: ".concat(p,"; width: 100%;")});Di(E,"isLine",!0);var C={height:0,top:1e4};return _.appendChild(E),v.forEach(function(w,R,S){var x=ts(w),P=x.isWordEnd,O=x.top,B=x.height,$=S[R+1];C.height=Math.max(C.height,B),C.top=Math.min(C.top,O),E.appendChild(w),P&&ts($).isWordStart&&E.append(" ")}),e.absolute&&Di(E,{height:C.height,top:C.top}),E}),n.words||ig(_),r.replaceChildren(_)),e.absolute&&(r.style.width="".concat(r.style.width||u,"px"),r.style.height="".concat(c,"px"),_s(s).forEach(function(v){var E=ts(v),C=E.isLine,w=E.top,R=E.left,S=E.width,x=E.height,P=ts(v.parentElement),O=!C&&P.isLine;v.style.top="".concat(O?w-P.top:w,"px"),v.style.left=C?"".concat(h.left,"px"):"".concat(R-(O?h.left:0),"px"),v.style.height="".concat(x,"px"),v.style.width=C?"".concat(h.width,"px"):"".concat(S,"px"),v.style.position="absolute"})),d&&(g?d.insertBefore(r,g):d.appendChild(r)),f}var Fs=es(_h,{}),rg=function(){bp(r,null,[{key:"clearData",value:function(){ow()}},{key:"setDefaults",value:function(t){return Fs=es(Fs,gl(t)),_h}},{key:"revert",value:function(t){wp(t).forEach(function(n){var i=ts(n),s=i.isSplit,o=i.html,a=i.cssWidth,l=i.cssHeight;s&&(n.innerHTML=o,n.style.width=a||"",n.style.height=l||"",X_(n))})}},{key:"create",value:function(t,n){return new r(t,n)}},{key:"data",get:function(){return vi}},{key:"defaults",get:function(){return Fs},set:function(t){Fs=es(Fs,gl(t))}}]);function r(e,t){YE(this,r),this.isSplit=!1,this.settings=es(Fs,gl(t)),this.elements=wp(e),this.split()}return bp(r,[{key:"split",value:function(t){var n=this;this.revert(),this.elements.forEach(function(o){Di(o,"html",o.innerHTML)}),this.lines=[],this.words=[],this.chars=[];var i=[window.pageXOffset,window.pageYOffset];t!==void 0&&(this.settings=es(this.settings,gl(t)));var s=ph(this.settings.types);s.none||(this.elements.forEach(function(o){Di(o,"isRoot",!0);var a=ng(o,n.settings),l=a.words,c=a.chars;n.words=[].concat(En(n.words),En(l)),n.chars=[].concat(En(n.chars),En(c))}),this.elements.forEach(function(o){if(s.lines||n.settings.absolute){var a=ww(o,n.settings,i);n.lines=[].concat(En(n.lines),En(a))}}),this.isSplit=!0,window.scrollTo(i[0],i[1]),aw())}},{key:"revert",value:function(){this.isSplit&&(this.lines=null,this.words=null,this.chars=null,this.isSplit=!1),r.revert(this.elements)}}]),r}();nt.registerPlugin($e);nt.registerPlugin($s);function vl(r,e){const t=document.querySelector(`#${r} .number`),n=r==="days"&&e>=100?String(e):("0"+e).slice(-2);if(t.dataset.value===n)return;t.dataset.value=n;const i=t.querySelectorAll(".char");nt.to(i,{y:-12,opacity:0,duration:.4,stagger:.05,onComplete:()=>{t.innerHTML=n.split("").map(o=>`<span class="char">${o}</span>`).join("");const s=t.querySelectorAll(".char");nt.from(s,{y:20,z:-500,opacity:0,duration:.42,stagger:.05,ease:"power1.out"})}})}function Tw(){const r=document.querySelector("#hero-area h1"),e=document.querySelector("#hero-number"),t=document.querySelector("#video video");if(!r||!e)return;window.lenis&&window.lenis.stop(),$e.getAll().forEach(c=>{(c.vars.trigger==="#hero-area"||c.vars.trigger==="#hero-travel-area")&&c.kill()});const n=e.innerText||"2026";e.innerHTML="",n.split("").forEach(c=>{const u=document.createElement("span");u.className="digit",u.textContent=c,u.setAttribute("data-digit",c),e.appendChild(u)}),nt.set(e,{opacity:0,autoAlpha:0});const i=new rg(r,{types:"words,chars",absolute:!1});nt.set(i.chars,{opacity:0,z:150,scale:1.2,transformPerspective:1e3,transformOrigin:"center center",filter:"blur(16px)"});const s=nt.timeline({delay:.5}),o=new CustomEvent("veryEarlyParticleFade");setTimeout(()=>{document.dispatchEvent(o)},840);const a=[...i.chars];for(let c=a.length-1;c>0;c--){const u=Math.floor(Math.random()*(c+1));[a[c],a[u]]=[a[u],a[c]]}s.to(a,{opacity:1,z:0,scale:1,filter:"blur(0px)",duration:1.25,stagger:.03,ease:"power2.out",onComplete:()=>{const c=new CustomEvent("particleFadeStart");document.dispatchEvent(c)}}),s.to(e,{opacity:1,autoAlpha:1,duration:.5,ease:"power1.inOut"});const l=e.querySelectorAll(".digit");s.fromTo(l,{opacity:0,y:10,z:-120,transformPerspective:1e3,transformOrigin:"center center"},{opacity:1,y:0,z:0,duration:2.5,stagger:.1,ease:"power3.out",onComplete:()=>{window.lenis&&window.lenis.start();const c=new CustomEvent("heroAnimationComplete");document.dispatchEvent(c)}},"-=0.6"),e&&(nt.fromTo(e,{opacity:0,scale:.8},{opacity:1,scale:1,duration:1.2,ease:"power2.out",delay:.5}),nt.to(e,{scale:.7,y:()=>window.innerWidth*-.1,ease:"none",scrollTrigger:{trigger:"#hero-travel-area",start:"top top",end:"bottom bottom",scrub:.5,markers:!1}}),nt.to(l,{color:"rgba(205, 252, 255, 0.9)",ease:"none",scrollTrigger:{trigger:"#hero-travel-area",start:"top top",end:"bottom bottom",scrub:!0,markers:!1}})),t&&(nt.set(t,{scale:.4,opacity:0,transformOrigin:"center center"}),nt.to(t,{scale:1,opacity:1,ease:"power1.out",scrollTrigger:{trigger:"#hero-travel-area",start:"top top",end:"bottom bottom",scrub:!0,markers:!1,onUpdate:c=>{c.progress>.8?t.classList.add("scale-active"):t.classList.remove("scale-active")}}}))}function Aw(){Tw(),Cw();const r=document.querySelector("button.menu");r&&r.addEventListener("click",()=>{const p=document.querySelector("nav"),b=document.querySelector("header");p&&p.classList.toggle("active"),b&&b.classList.toggle("nav-active")});const e=document.querySelector("button.close-menu");e&&e.addEventListener("click",()=>{const p=document.querySelector("nav"),b=document.querySelector("header");p&&p.classList.remove("active"),b&&b.classList.remove("nav-active")});const t=document.querySelector("#hero-area h1");if(t){let p=t.querySelectorAll(".char");p.length||(p=new rg(t,{types:"words,chars",absolute:!1}).chars);const b=nt.timeline({scrollTrigger:{trigger:"#hero-travel-area",start:"top center",end:"top top",scrub:!0,markers:!1}}),y=[...p];for(let v=y.length-1;v>0;v--){const E=Math.floor(Math.random()*(v+1));[y[v],y[E]]=[y[E],y[v]]}b.to(y,{opacity:0,z:-50,stagger:.02,ease:"power1.in"},0)}const n=document.querySelector("#hero-number");if(n){const p={year:2026};nt.to(p,{year:1876,ease:"none",scrollTrigger:{trigger:"#hero-travel-area",start:"top top",end:"bottom bottom",scrub:!0,markers:!1},onUpdate:function(){const y=Math.round(p.year).toString(),v=n.querySelectorAll(".digit"),E=y.split("");v.length!==E.length?(n.innerHTML="",E.forEach(C=>{const w=document.createElement("span");w.className="digit",w.textContent=C,w.setAttribute("data-digit",C),n.appendChild(w)})):v.forEach((C,w)=>{C.textContent!==E[w]&&(C.textContent=E[w],C.setAttribute("data-digit",E[w]),nt.fromTo(C,{opacity:.7},{opacity:1,duration:.2,ease:"power1.out"}))})}}),nt.to(n,{scale:.5,y:()=>window.innerWidth*-.2,ease:"none",scrollTrigger:{trigger:"#hero-travel-area",start:"top top",end:"bottom bottom",scrub:.5,markers:!1}});const b=n.querySelectorAll(".digit");nt.to(b,{color:"rgba(205, 252, 255, 0.9)",ease:"none",scrollTrigger:{trigger:"#hero-travel-area",start:"top top",end:"bottom bottom",scrub:!0,markers:!1}})}document.querySelectorAll(".pin-top-top").forEach(function(p){let b=p.parentElement;p.id==="hero-area"?$e.create({trigger:b,start:"top top",end:"bottom bottom",pin:p,pinSpacing:!1,endTrigger:"#hero-travel-area",onLeaveBack:y=>{y.pin.style.transform="translate3d(0px, 0px, 0px)"}}):$e.create({trigger:b,start:"top top",end:"bottom bottom",pin:p,pinSpacing:!1})}),document.querySelectorAll(".reveal-top-center").forEach(function(p){nt.set(p,{opacity:0}),nt.to(p,{opacity:1,ease:"power1.out",scrollTrigger:{trigger:p,start:"top center",toggleActions:"restart none none reverse"}})}),document.querySelectorAll(".reveal-center-center").forEach(function(p){nt.set(p,{opacity:0}),nt.to(p,{opacity:1,ease:"power1.out",scrollTrigger:{trigger:p,start:"center center",toggleActions:"restart none none reverse"}})}),document.querySelectorAll(".pin-top-center").forEach(function(p){let b=p.parentElement;$e.create({trigger:b,start:"top center",end:"bottom bottom",pin:p,pinSpacing:!1})}),document.querySelectorAll(".pin-center-center").forEach(function(p){let b=p.parentElement;$e.create({trigger:b,start:"center center",end:"bottom bottom",pin:p,pinSpacing:!1})}),document.querySelectorAll(".pin-bottom-bottom").forEach(function(p){let b=p.parentElement;$e.create({trigger:b,start:"bottom bottom",end:"",pin:p,pinSpacing:!1})});const i=document.querySelector(".years"),s={weight:100};if(i){const p={year:2026};i.innerText=p.year.toString(),nt.to(p,{year:1876,ease:"none",scrollTrigger:{trigger:"#years-travel-area",start:"top -80%",end:"bottom 180%",scrub:!0},onUpdate:function(){i.innerText=Math.round(p.year).toString()}}),nt.to(s,{weight:900,ease:"power2.inOut",scrollTrigger:{trigger:"#years-travel-area",start:"top -80%",end:"bottom 180%",scrub:!0},onUpdate:function(){i.style.fontWeight=Math.round(s.weight).toString()}}),nt.fromTo(i,{scale:.5},{scale:1.5,ease:"power2.inOut",scrollTrigger:{trigger:"#years-travel-area",start:"top top",end:"bottom bottom",scrub:!0}})}const o=document.getElementById("anniversary-area");if(o){let p=o.querySelector("#marquee");if(!p){p=document.createElement("div"),p.id="marquee",p.style.position="absolute",p.style.bottom="0",p.style.left="0";const b="150 YEARS OF AMERICAN CHEMICAL SOCIETY ";p.innerHTML=`<span>${b}</span><span>${b}</span>`,o.appendChild(p),nt.to(p,{xPercent:-50,ease:"linear",duration:20,repeat:-1})}}const a=document.getElementById("waveGroup");if(!a)return;nt.to(a,{x:"-=100",ease:"linear",duration:2,repeat:-1});const l=document.querySelector(".section-timeline .page-nav"),c=l.querySelectorAll("a"),u=document.querySelector(".section-timeline .indicator .active-title"),h=document.querySelector(".section-timeline .indicator-wrapper"),f=document.querySelector(".timeline-nav-wrapper");let d=!1;nt.set(c,{opacity:0,x:-20}),nt.set(u,{opacity:1});const g=()=>{nt.killTweensOf(u),nt.killTweensOf(c)},_=()=>{g(),d=!0,nt.set(u,{opacity:0}),nt.to(c,{opacity:1,x:0,duration:.4,stagger:.05,ease:"power2.out"})},m=()=>{g(),d=!1,nt.to(c,{opacity:0,x:-20,duration:.3,stagger:.03,ease:"power2.in",onComplete:()=>{d||nt.to(u,{opacity:1,duration:.4,ease:"power2.out"})}})};if(h){h.removeEventListener("mouseenter",_);const p=h.onmouseleave;p&&h.removeEventListener("mouseleave",p)}if(l){l.removeEventListener("mouseenter",_);const p=l.onmouseleave;p&&l.removeEventListener("mouseleave",p)}if(f){f.removeEventListener("mouseenter",_);const p=f.onmouseleave;p&&f.removeEventListener("mouseleave",p)}f?(f.addEventListener("mouseenter",()=>{_()}),f.addEventListener("mouseleave",()=>{m()})):(h.addEventListener("mouseenter",_),l.addEventListener("mouseenter",_),h.addEventListener("mouseleave",p=>{(!p.relatedTarget||!l.contains(p.relatedTarget))&&m()}),l.addEventListener("mouseleave",p=>{(!p.relatedTarget||!h.contains(p.relatedTarget))&&m()})),c.forEach(p=>{const b=p.onclick;b&&p.removeEventListener("click",b),p.addEventListener("click",y=>{y.preventDefault(),g(),c.forEach(v=>v.classList.remove("active")),p.classList.add("active"),u.textContent=p.textContent,nt.to(c,{opacity:0,x:-20,duration:.3,stagger:.03,ease:"power2.in",onComplete:()=>{d=!1,nt.to(u,{opacity:1,duration:.4,ease:"power2.out"})}})})})}function Cw(){const r=document.querySelector("#video video");r&&(nt.set(r,{scale:.4,opacity:0,transformOrigin:"center center"}),nt.to(r,{scale:1,opacity:1,ease:"power1.out",scrollTrigger:{trigger:"#hero-travel-area",start:"top top",end:"bottom bottom",scrub:!0,markers:!1,onUpdate:e=>{e.progress>.8?r.classList.add("scale-active"):r.classList.remove("scale-active")}}}))}function Rw(r){function e(){const t=Date.now(),n=r-t;if(n<0)return;const i=Math.floor(n/(1e3*60*60*24)),s=Math.floor(n%(1e3*60*60*24)/(1e3*60*60)),o=Math.floor(n%(1e3*60*60)/(1e3*60)),a=Math.floor(n%(1e3*60)/1e3);i>=100?String(i):("0"+i).slice(-2),("0"+s).slice(-2),("0"+o).slice(-2),("0"+a).slice(-2),vl("days",i),vl("hours",s),vl("minutes",o),vl("seconds",a)}e(),setInterval(e,1e3)}const Pw=new Date("2026-04-06T00:00:00").getTime();history.scrollRestoration&&(history.scrollRestoration="manual");window.scrollTo(0,0);window.addEventListener("beforeunload",()=>{window.scrollTo(0,0),sessionStorage.setItem("scrollToTop","true")});window.addEventListener("load",()=>{window.scrollTo({top:0,left:0,behavior:"instant"}),setTimeout(()=>{window.scrollTo(0,0)},10)});document.addEventListener("DOMContentLoaded",()=>{window.scrollTo(0,0),window.lenis=new mg({autoRaf:!0}),window.lenis.on("scroll",r=>{}),Rw(Pw),Wb(),Aw(),setTimeout(()=>{window.scrollTo(0,0),window.lenis.scrollTo(0,{immediate:!0})},100)});
